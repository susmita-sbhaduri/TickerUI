 ...
 */
package org.taalmaan.services.TaalMaanServices;
...
import org.taalmaan.taaldetect.DTO.TaalDetectDTO;
import org.taalmaan.taaldetect.DTO.TaalDetectResponse;
import org.taalmaan.taalDetect.TaalDetectService;
import org.taalmaan.params.DBResponse;
import org.taalmaan.params.SONGPARAM;
import org.taalmaan.utils.DatabaseConnection;
import org.taalmaan.utils.TaalMaanAuthCredtialValue;
import org.taalmaan.utils.TaalMaanAuthentication;
...
import org.taalmaan.db.DAO.SysParamDAO;
import org.taalmaan.db.DAO.SongDetailsDAO;
import org.taalmaan.db.DAO.TaalparamDAO;
...
import org.taalmaan.db.entities.Taalparam;
...
public class SongDataService {
    ...
    public AwsS3KeyDTO getAWSKeys() {
        SysParamDAO paramDAO = new SysParamDAO(emf);
        Taalsysparams pa = paramDAO.findTaalsysparams("accessKey");
        Taalsysparams ps = paramDAO.findTaalsysparams("secretKey");
        AwsS3KeyDTO awsS3KeyDTO = new AwsS3KeyDTO(pa.getTaalvalue(), ps.getTaalvalue());
        return awsS3KeyDTO;
    }
